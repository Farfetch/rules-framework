namespace Rules.Framework.Tests.Evaluation.Compiled
{
    ...
    public class OneToOneValueConditionNodeExpressionBuilderTests
    {
        ...
        public void Build_GivenExpressionBuilderAndArgs_BuildsExpression()
        {
            ...
            using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Rules.Framework.Tests.Evaluation.Compiled.OneToOneValueConditionNodeExpressionBuilderTests.GoldenFile1.csx"))
