namespace Rules.Framework.Tests.Evaluation.Compiled
{
    ...
    public class OneToManyValueConditionNodeExpressionBuilderTests
    {
        ...
        public void Build_GivenLefthandOperatorRightHandAndDataTypeConfiguration_ReturnsExpression()
        {
            ...
            using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Rules.Framework.Tests.Evaluation.Compiled.OneToManyValueConditionNodeExpressionBuilderTests.GoldenFile1.csx"))
            ...
            FluentActions.Invoking(() => compiledLambdaExpression.Invoke("abc", new string[] { "dummy" }))
                .Should()
