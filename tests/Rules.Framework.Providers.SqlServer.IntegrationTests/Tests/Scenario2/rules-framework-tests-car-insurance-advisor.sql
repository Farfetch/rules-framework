...
insert into [@schemaname].ContentTypes values (1, 'CarInsuranceAdvice')

insert into [@schemaname].ConditionTypes values (1, 'RepairCosts') 
insert into [@schemaname].ConditionTypes values (2, 'RepairCostsCommercialValueRate') 


--Rule 1

insert into [@schemaname].ConditionNodes ([ConditionNodeTypeCode], [ConditionTypeCode], [DataTypeCode], [OperatorCode], [Operand], [LogicalOperatorCode])
values (1, 2, 2, 5, '80', 3)

DECLARE @ConditionNodeId AS BIGINT = (SELECT SCOPE_IDENTITY())

insert into [@schemaname].Rules ([Content], [ContentTypeCode], [DateBegin], [DateEnd], [Name], [Priority], [ConditionNodeId])
...
INSERT INTO [@schemaname].ConditionNodeRelations ([OwnerId], [ChildId]) VALUES (@ParentNodeId, @Child1NodeId)
INSERT INTO [@schemaname].ConditionNodeRelations ([OwnerId], [ChildId]) VALUES (@ParentNodeId, @Child2NodeId)
