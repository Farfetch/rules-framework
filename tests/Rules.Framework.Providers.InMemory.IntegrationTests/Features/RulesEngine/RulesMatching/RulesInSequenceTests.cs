namespace Rules.Framework.Providers.InMemory.IntegrationTests.Features.RulesEngine.RulesMatching
{
    ...
    {
        // private static readonly DateTime ruleChangeDateBefore = new DateTime(2021, 01, 01).AddMilliseconds(-1);
        ...
        public static IEnumerable<object[]> TestCases =>
            new List<object[]>
            {
                ...
                new object[] { rule2EndDate.AddDays(-2), rule2Name, rule2Value }, // 2nd rule
            };
