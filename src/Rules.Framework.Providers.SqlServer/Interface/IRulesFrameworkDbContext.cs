...
namespace Rules.Framework.SqlServer.Models
{
    ...
    public interface IRulesFrameworkDbContext : IDisposable
    {
        DbSet<ConditionNode> ConditionNodes { get; set; } // ConditionNodes
        DbSet<ConditionNodeRelation> ConditionNodeRelations { get; set; } // ConditionNodeRelations
        DbSet<ConditionNodeType> ConditionNodeTypes { get; set; } // ConditionNodeTypes
