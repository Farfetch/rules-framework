namespace Rules.Framework.Evaluation.Compiled
{
    ...
    internal sealed class ManyToOneValueConditionNodeCompiler : ValueConditionNodeCompilerBase, IValueConditionNodeCompiler
    {
        private readonly IConditionExpressionBuilderProvider conditionExpressionBuilderProvider;

        public ManyToOneValueConditionNodeCompiler(
            ...
            ParameterExpression parameterExpression)
        {
            ...
            var conditionExpressionBuilder = this.conditionExpressionBuilderProvider.GetConditionExpressionBuilderFor(valueConditionNode.Operator, Multiplicities.ManyToOne);
